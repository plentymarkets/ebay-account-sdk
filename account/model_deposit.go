...
type Deposit struct {
	...
	// For deposits (which are applicable to only motor listings), the <b>paymentMethodType</b> must be set to '<code>PAYPAL</code>' and you must also populate the fields in the <b>recipientAccountReference</b> object.  <br><br><i>Required if</i> your motor vehicles listing requires a deposit.
