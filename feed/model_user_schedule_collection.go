...
// SetSchedules gets a reference to the given []UserScheduleResponse and assigns it to the Schedules field.
...
func (o UserScheduleCollection) MarshalJSON() ([]byte, error) {
...
type NullableUserScheduleCollection struct {
	value *UserScheduleCollection
	isSet bool
}

func (v NullableUserScheduleCollection) Get() *UserScheduleCollection {
	return v.value
}

func (v *NullableUserScheduleCollection) Set(val *UserScheduleCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableUserScheduleCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableUserScheduleCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserScheduleCollection(val *UserScheduleCollection) *NullableUserScheduleCollection {
	return &NullableUserScheduleCollection{value: val, isSet: true}
}

func (v NullableUserScheduleCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserScheduleCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
