...
type FulfillmentPolicy struct {
	...
	// An optional seller-defined description of the fulfillment policy.  <br><br><b>Max length</b>: 250
	Description *string `json:"description,omitempty"`
	// If set to <code>true</code>, the seller offers freight shipping. Freight shipping can be used for large items over 150 lbs.<br><br><b>Default</b>: <code>false</code>
...
func (o FulfillmentPolicy) MarshalJSON() ([]byte, error) {
